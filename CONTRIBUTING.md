...
Welcome to `researchrobot` contributor's guide.
...
If you experience bugs or general issues with `researchrobot`, please have a look
...
You can help improve `researchrobot` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`researchrobot` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `researchrobot`'s files. While this mechanism can
...
```
conda create -n researchrobot python=3 six virtualenv pytest pytest-cov
conda activate researchrobot
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/researchrobot.git
   cd researchrobot
   ```
...
5. Install [pre-commit]:
   ...
   `researchrobot` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/researchrobot
[issue tracker]: https://github.com/<USERNAME>/researchrobot/issues
